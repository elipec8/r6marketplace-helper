...
class CustomUserPostgresRepositoryTest {
    ...
    void findToBeNotifiedUserChatIdById_should_return_expected_user() {
        ...
        try {
            ...
            assertEquals(new ToBeNotifiedUserProjection("chatId", false, true, false, true, false),
                    customUserPostgresRepository.findToBeNotifiedUserIdById(user.getId()).orElse(null));
        } finally {
            entityManager.close();
        }
    }
    ...
    public void findAllToBeNotifiedUsers_should_return_expected_users() {
        ...
        try {
            ...
            List<ToBeNotifiedUserProjection> result = customUserPostgresRepository.findAllToBeNotifiedUsers();
