...
import github.ricemonger.marketplace.databases.postgres.repositories.CustomTagPostgresRepository;
...
public class TagPostgresService implements TagDatabaseService {
    ...
    private final CustomTagPostgresRepository tagRepository;
