...
class FilterEditStage1AskNameCallbackTest {
    ...
    public void initAndExecute_should_process_first_input_and_sent_text() {
        ...
        verify(botInnerService).clearUserInputsAndSetInputStateAndGroup(MockUpdateInfos.UPDATE_INFO.getChatId(), InputState.ITEM_FILTER_NAME, InputGroup.ITEM_FILTER_EDIT);
    }
}