...
class ItemsShowSettingsChangeMessageLimitCallbackTest {
    ...
    public void initAndExecute_should_process_first_input() {
        ...
        verify(botInnerService).clearUserInputsAndSetInputStateAndGroup(MockUpdateInfos.UPDATE_INFO.getChatId(), InputState.ITEMS_SHOW_SETTING_MESSAGE_LIMIT, InputGroup.ITEMS_SHOW_SETTINGS_CHANGE_MESSAGE_LIMIT);
