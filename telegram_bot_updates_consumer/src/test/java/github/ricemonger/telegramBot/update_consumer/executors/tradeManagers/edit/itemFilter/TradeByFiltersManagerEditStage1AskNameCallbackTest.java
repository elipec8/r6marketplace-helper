...
class TradeByFiltersManagerEditStage1AskNameCallbackTest {
    ...
    public void initAndExecute_should_process_first_input_with_text() {
        ...
        verify(botInnerService).clearUserInputsAndSetInputStateAndGroup(MockUpdateInfos.UPDATE_INFO.getChatId(), InputState.TRADE_BY_FILTERS_MANAGER_NAME, InputGroup.TRADE_BY_FILTERS_MANAGER_EDIT);
