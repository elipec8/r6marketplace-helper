...
@SpringBootTest
class TradeManagersSettingsChangeSellTradePriorityExpressionAskConfirmInputTest {
    @MockBean
    private BotInnerService botInnerService;

    @Test
    public void initAndExecute_should_ask_to_update_expression_and_process_last_input_if_expression_valid() {
        TradeManagersSettingsChangeSellTradePriorityExpressionAskConfirmInput executor = new TradeManagersSettingsChangeSellTradePriorityExpressionAskConfirmInput();
