...
class TradeByItemIdManagerRemoveOrChangeEnabledStage1AskItemIdCallbackTest {
    ...
    public void initAndExecute_should_process_first_input() {
        ...
        verify(botInnerService).clearUserInputsAndSetInputStateAndGroup(MockUpdateInfos.UPDATE_INFO.getChatId(), InputState.TRADE_BY_ITEM_ID_MANAGER_ITEM_ID, InputGroup.TRADE_BY_ITEM_ID_MANAGER_SHOW_OR_REMOVE);
