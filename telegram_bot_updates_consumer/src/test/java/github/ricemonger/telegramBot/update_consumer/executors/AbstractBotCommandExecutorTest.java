...
class AbstractBotCommandExecutorTest {
    ...
    public void processFirstInput_with_text_should_clear_user_inputs_and_set_state_and_group_and_send_text() {
        ...
        verify(botInnerService).clearUserInputsAndSetInputStateAndGroup(updateInfo.getChatId(), InputState.ITEM_FILTER_ITEM_NAME_PATTERNS, InputGroup.ITEMS_SHOW_SETTINGS_CHANGE_MESSAGE_LIMIT);
    ...
    public void cancel_should_reset_inputs_and_send_text() {
        ...
        verify(botInnerService).clearUserInputsAndSetInputStateAndGroup(updateInfo.getChatId(), InputState.BASE, InputGroup.BASE);
