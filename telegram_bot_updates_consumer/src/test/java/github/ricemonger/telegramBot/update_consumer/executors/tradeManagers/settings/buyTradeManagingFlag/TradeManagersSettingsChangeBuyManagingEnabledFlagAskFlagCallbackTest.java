...
@SpringBootTest
class TradeManagersSettingsChangeBuyManagingEnabledFlagAskFlagCallbackTest {
    @MockBean
    private BotInnerService botInnerService;

    @Test
    public void initAndExecute_Should_askYesORNoFromInlineKeyboard() {
        TradeManagersSettingsChangeBuyManagingEnabledFlagAskFlagCallback executor = new TradeManagersSettingsChangeBuyManagingEnabledFlagAskFlagCallback();
        executor.initAndExecute(MockUpdateInfos.UPDATE_INFO, botInnerService);

        CallbackButton yesButton = new CallbackButton("Yes", Callbacks.TRADE_MANAGERS_SETTINGS_CHANGE_BUY_MANAGING_ENABLED_FLAG_YES);
        CallbackButton noButton = new CallbackButton("No", Callbacks.TRADE_MANAGERS_SETTINGS_CHANGE_BUY_MANAGING_ENABLED_FLAG_NO);
