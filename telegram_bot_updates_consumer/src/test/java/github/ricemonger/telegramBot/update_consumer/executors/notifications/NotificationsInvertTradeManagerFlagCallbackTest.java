...
@SpringBootTest
class NotificationsInvertTradeManagerFlagCallbackTest {
    @MockBean
    private BotInnerService botInnerService;

    @Test
    public void initAndExecute_should_invert_flag_and_send_text() {
        NotificationsInvertTradeManagerFlagCallback command = new NotificationsInvertTradeManagerFlagCallback();
        command.initAndExecute(MockUpdateInfos.UPDATE_INFO, botInnerService);

        verify(botInnerService).invertUserTradeManagerNotificationsFlag(MockUpdateInfos.UPDATE_INFO.getChatId());
