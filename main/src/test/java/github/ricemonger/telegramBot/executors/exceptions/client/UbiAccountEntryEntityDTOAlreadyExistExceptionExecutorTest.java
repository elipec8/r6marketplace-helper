...
import github.ricemonger.telegramBot.update_consumer.executors.exceptions.client.UbiAccountEntryAlreadyExistExceptionExecutor;
...
@SpringBootTest
class UbiAccountEntryEntityDTOAlreadyExistExceptionExecutorTest {
    @MockBean
