...
public abstract class AbstractBotCommandExecutor {
    ...
    protected final void processMiddleInput(InputState nextInputState) {
        botInnerService.saveUserInputAndSetInputState(updateInfo, nextInputState);
    }
    ...
    protected final void processLastInput() {
        botInnerService.saveUserInputAndSetInputStateAndGroup(updateInfo, InputState.BASE, InputGroup.BASE);
    }
