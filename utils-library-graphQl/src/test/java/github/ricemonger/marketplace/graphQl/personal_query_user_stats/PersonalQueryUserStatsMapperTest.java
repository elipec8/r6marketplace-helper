...
class PersonalQueryUserStatsMapperTest {
    ...
    private Meta createMeta() {
        ...
        currentTradesNodes.add(new Nodes("tradeId1", "Created", "Buy", "2021-01-01", "2021-01-01",
                new TradeItems[]{new TradeItems(new github.ricemonger.marketplace.graphQl.personal_query_user_stats.DTO.meta.trades.nodes.tradeItems.Item("1"))}, new Payment(1000, 100), new PaymentOptions[]{new PaymentOptions(199)}, null));
        currentTradesNodes.add(new Nodes("tradeId2", "Created", "Buy", "2021-01-01", "2021-01-01",
                new TradeItems[]{new TradeItems(new github.ricemonger.marketplace.graphQl.personal_query_user_stats.DTO.meta.trades.nodes.tradeItems.Item("2"))}, new Payment(1000, 100), null, new PaymentProposal(299)));
        ...
        finishedTradesNodes.add(new Nodes("tradeId3", "Created", "Buy", "2021-01-01", "2021-01-01",
                new TradeItems[]{new TradeItems(new github.ricemonger.marketplace.graphQl.personal_query_user_stats.DTO.meta.trades.nodes.tradeItems.Item("3"))}, new Payment(1000, 100), new PaymentOptions[]{}, new PaymentProposal(499)));
    ...
    @Test
    public void mapOrderss_should_map_each_order() {
