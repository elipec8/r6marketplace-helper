...
import github.ricemonger.marketplace.graphQl.config_query_trade.ConfigQueryTradeMapper;
...
class ConfigQueryTradeMapperTest {
    ...
    private final ConfigQueryTradeMapper configQueryTradeMapper = new ConfigQueryTradeMapper();
