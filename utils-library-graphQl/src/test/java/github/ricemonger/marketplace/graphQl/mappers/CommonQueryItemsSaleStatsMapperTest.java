...
class CommonQueryItemsSaleStatsMapperTest {
    ...
    private final CommonQueryItemsSaleStatsMapper commonQueryItemsSaleStatsMapper = spy(new CommonQueryItemsSaleStatsMapper(commonValuesService));

    @Test
    public void mapItemsSaleStats_should_call_map_itemSaleStats_for_each_node() throws ParseException {
        when(commonValuesService.getItemSaleStatsDateFormat()).thenReturn("yyyy-MM-dd HH:mm:ss");
