...
class CustomItemPostgresRepositoryTest {
    ...
    public void updateAllHistoryFields_should_update_by_projectionsItems() {
        ...
        customItemPostgresRepository.save(existingItem1);
        customItemPostgresRepository.save(existingItem2);
        customItemPostgresRepository.save(existingItem3);
        ...
        customItemPostgresRepository.updateAllItemsHistoryFields(List.of(projection1, projection2));

        List<ItemEntity> result = customItemPostgresRepository.findAll();
    ...
    public void updateHistoryFields_should_update_by_projection() {
        ...
        customItemPostgresRepository.updateHistoryFields(projection1);
    ...
    public void findAllItemRecalculationRequiredFields_should_return_all_fields() {
        ...
        List<ItemRecalculationRequiredFieldsProjection> result = customItemPostgresRepository.findAllItemsRecalculationRequiredFields();
