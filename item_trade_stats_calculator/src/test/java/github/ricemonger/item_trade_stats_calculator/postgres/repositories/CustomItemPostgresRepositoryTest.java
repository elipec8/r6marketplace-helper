...
class CustomItemPostgresRepositoryTest {
    ...
    @Test
    public void updateAllItemsCurrentPricesHistoryFields_should_update_by_projectionsItems() {
        ItemEntity existingItem1 = new ItemEntity();
        existingItem1.setItemId("itemId1");
        existingItem1.setAssetUrl("assetUrl1");
        existingItem1.setName("name1");
        ...
        ItemCurrentPricesHistoryFieldsProjection projection1 = new ItemCurrentPricesHistoryFieldsProjection();
        projection1.setItemId("itemId1");
        projection1.setPriorityToSellByMaxBuyPrice(1012L);
        projection1.setPriorityToSellByNextFancySellPrice(1013L);
        projection1.setPriorityToBuyByMinSellPrice(1014L);

        ItemCurrentPricesHistoryFieldsProjection projection2 = new ItemCurrentPricesHistoryFieldsProjection();
        projection2.setItemId("itemId2");
        projection2.setPriorityToSellByMaxBuyPrice(2012L);
        projection2.setPriorityToSellByNextFancySellPrice(2013L);
        projection2.setPriorityToBuyByMinSellPrice(2014L);

        customItemPostgresRepository.updateAllItemsCurrentPricesHistoryFields(List.of(projection1, projection2));
        ...
        expectedItem1.setMinSellPrice(103);
        expectedItem1.setSellOrdersCount(104);
        expectedItem1.setMonthAveragePrice(105);
        expectedItem1.setMonthMedianPrice(106);
        expectedItem1.setMonthMaxPrice(107);
        expectedItem1.setMonthMinPrice(108);
        expectedItem1.setMonthSalesPerDay(109);
        expectedItem1.setMonthSales(110);
        expectedItem1.setDayAveragePrice(111);
        expectedItem1.setDayMedianPrice(112);
        expectedItem1.setDayMaxPrice(113);
        expectedItem1.setDayMinPrice(114);
        expectedItem1.setDaySales(115);
        expectedItem1.setPriorityToSellByMaxBuyPrice(1012L);
        expectedItem1.setPriorityToSellByNextFancySellPrice(1013L);
        expectedItem1.setPriorityToBuyByMinSellPrice(1014L);
        expectedItem1.setPriorityToBuyIn1Hour(119L);
        expectedItem1.setPriorityToBuyIn6Hours(120L);
        expectedItem1.setPriorityToBuyIn24Hours(121L);
        expectedItem1.setPriorityToBuyIn168Hours(122L);
        expectedItem1.setPriorityToBuyIn720Hours(123L);
        expectedItem1.setPriceToBuyIn1Hour(124);
        expectedItem1.setPriceToBuyIn6Hours(125);
        expectedItem1.setPriceToBuyIn24Hours(126);
        expectedItem1.setPriceToBuyIn168Hours(127);
        expectedItem1.setPriceToBuyIn720Hours(128);
        ...
        expectedItem2.setMinSellPrice(203);
        expectedItem2.setSellOrdersCount(204);
        expectedItem2.setMonthAveragePrice(205);
        expectedItem2.setMonthMedianPrice(206);
        expectedItem2.setMonthMaxPrice(207);
        expectedItem2.setMonthMinPrice(208);
        expectedItem2.setMonthSalesPerDay(209);
        expectedItem2.setMonthSales(210);
        expectedItem2.setDayAveragePrice(211);
        expectedItem2.setDayMedianPrice(212);
        expectedItem2.setDayMaxPrice(213);
        expectedItem2.setDayMinPrice(214);
        expectedItem2.setDaySales(215);
        expectedItem2.setPriorityToSellByMaxBuyPrice(2012L);
        expectedItem2.setPriorityToSellByNextFancySellPrice(2013L);
        expectedItem2.setPriorityToBuyByMinSellPrice(2014L);
        expectedItem2.setPriorityToBuyIn1Hour(219L);
        expectedItem2.setPriorityToBuyIn6Hours(220L);
        expectedItem2.setPriorityToBuyIn24Hours(221L);
        expectedItem2.setPriorityToBuyIn168Hours(222L);
        expectedItem2.setPriorityToBuyIn720Hours(223L);
        expectedItem2.setPriceToBuyIn1Hour(224);
        expectedItem2.setPriceToBuyIn6Hours(225);
        expectedItem2.setPriceToBuyIn24Hours(226);
        expectedItem2.setPriceToBuyIn168Hours(227);
        expectedItem2.setPriceToBuyIn720Hours(228);
    ...
    @Test
    public void updateItemCurrentPricesHistoryFields_should_update_by_projection() {
        ItemEntity existingItem1 = new ItemEntity();
        existingItem1.setItemId("itemId1");
        existingItem1.setAssetUrl("assetUrl1");
        existingItem1.setName("name1");
        ...
        customItemPostgresRepository.updateItemCurrentPricesHistoryFields(projection1);
        customItemPostgresRepository.updateItemCurrentPricesHistoryFields(projection2);
    ...
    @Test
    public void findAllItemsCurrentPricesRecalculationRequiredFields_should_return_all_fields() {
        ItemEntity existingItem1 = new ItemEntity();
        existingItem1.setItemId("itemId1");
        existingItem1.setAssetUrl("assetUrl1");
        existingItem1.setName("name1");
        ...
        existingItem1.setMinSellPrice(103);
        existingItem1.setSellOrdersCount(104);
        existingItem1.setMonthMedianPrice(105);
        existingItem1.setMonthSalesPerDay(106);
        existingItem1.setMonthSales(107);
        ...
        existingItem2.setMinSellPrice(203);
        existingItem2.setSellOrdersCount(204);
        existingItem2.setMonthMedianPrice(205);
        existingItem2.setMonthSalesPerDay(206);
        existingItem2.setMonthSales(207);
        ...
        existingItem3.setMinSellPrice(303);
        existingItem3.setSellOrdersCount(304);
        existingItem3.setMonthMedianPrice(305);
        existingItem3.setMonthSalesPerDay(306);
        existingItem3.setMonthSales(307);

        customItemPostgresRepository.save(existingItem1);
        customItemPostgresRepository.save(existingItem2);
        customItemPostgresRepository.save(existingItem3);

        List<ItemCurrentPricesRecalculationRequiredFieldsProjection> result = customItemPostgresRepository.findAllItemsCurrentPricesRecalculationRequiredFields();

        ItemCurrentPricesRecalculationRequiredFieldsProjection expectedItem1 = new ItemCurrentPricesRecalculationRequiredFieldsProjection();
        expectedItem1.setItemId("itemId1");
        expectedItem1.setRarity(ItemRarity.RARE);
        expectedItem1.setMaxBuyPrice(101);
        expectedItem1.setMinSellPrice(103);
        expectedItem1.setSellOrdersCount(104);
        expectedItem1.setMonthMedianPrice(105);
        expectedItem1.setMonthSalesPerDay(106);
        expectedItem1.setMonthSales(107);

        ItemCurrentPricesRecalculationRequiredFieldsProjection expectedItem2 = new ItemCurrentPricesRecalculationRequiredFieldsProjection();
        expectedItem2.setItemId("itemId2");
        expectedItem2.setRarity(ItemRarity.EPIC);
        expectedItem2.setMaxBuyPrice(201);
        expectedItem2.setMinSellPrice(203);
        expectedItem2.setSellOrdersCount(204);
        expectedItem2.setMonthMedianPrice(205);
        expectedItem2.setMonthSalesPerDay(206);
        expectedItem2.setMonthSales(207);

        ItemCurrentPricesRecalculationRequiredFieldsProjection expectedItem3 = new ItemCurrentPricesRecalculationRequiredFieldsProjection();
        expectedItem3.setItemId("itemId3");
        expectedItem3.setRarity(ItemRarity.LEGENDARY);
        expectedItem3.setMaxBuyPrice(301);
        expectedItem3.setMinSellPrice(303);
        expectedItem3.setSellOrdersCount(304);
        expectedItem3.setMonthMedianPrice(305);
        expectedItem3.setMonthSalesPerDay(306);
        expectedItem3.setMonthSales(307);
