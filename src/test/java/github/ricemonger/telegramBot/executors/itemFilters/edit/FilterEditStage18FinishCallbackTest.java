...
@SpringBootTest
class FilterEditStage18FinishCallbackTest {
    @MockBean
    private BotInnerService botInnerService;

    @Test
    public void initAndExecute_should_save_item_filter_by_user_inputs_and_notify_user() {
        FilterEditStage18FinishCallback filterEditStage18FinishCallback = new FilterEditStage18FinishCallback();
        filterEditStage18FinishCallback.initAndExecute(MockUpdateInfos.UPDATE_INFO, botInnerService);
