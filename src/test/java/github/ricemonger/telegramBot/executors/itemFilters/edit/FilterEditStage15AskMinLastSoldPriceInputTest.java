...
@SpringBootTest
class FilterEditStage15AskMinLastSoldPriceInputTest {
    @MockBean
    private BotInnerService botInnerService;

    @Test
    public void initAndExecute_should_process_middle_input_with_skip_button() {
        FilterEditStage15AskMinLastSoldPriceInput commandExecutor = new FilterEditStage15AskMinLastSoldPriceInput();
