...
@SpringBootTest
class FilterRemoveConfirmedCallbackTest {
    @MockBean
    private BotInnerService botInnerService;

    @Test
    public void initAndExecute_should_remove_item_filter_by_inputted_name_and_notify_user() {
        FilterRemoveConfirmedCallback filterRemoveConfirmedCallback = new FilterRemoveConfirmedCallback();
        filterRemoveConfirmedCallback.initAndExecute(MockUpdateInfos.UPDATE_INFO, botInnerService);
