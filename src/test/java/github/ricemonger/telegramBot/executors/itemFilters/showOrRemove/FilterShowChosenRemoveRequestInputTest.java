...
@SpringBootTest
class FilterShowChosenRemoveRequestInputTest {
    @MockBean
    ...
    public void initAndExecute_should_process_last_input_and_show_filter_and_ask_from_inline_keyboard_if_item_filter_should_be_removed() {
        ...
        FilterShowChosenRemoveRequestInput filterShowChosenRemoveRequestInput = new FilterShowChosenRemoveRequestInput();
        filterShowChosenRemoveRequestInput.initAndExecute(MockUpdateInfos.UPDATE_INFO, botInnerService);
