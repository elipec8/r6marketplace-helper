...
@SpringBootTest
class TradeByItemIdManagerBuyEditStage5AskConfirmationInputTest {
    @MockBean
    private BotInnerService botInnerService;

    @Test
    public void initAndExecute_should_process_last_input_and_ask_confirmation() {
        TradeByItemIdManagerBuyEditStage5AskConfirmationInput commandExecutor = new TradeByItemIdManagerBuyEditStage5AskConfirmationInput();
