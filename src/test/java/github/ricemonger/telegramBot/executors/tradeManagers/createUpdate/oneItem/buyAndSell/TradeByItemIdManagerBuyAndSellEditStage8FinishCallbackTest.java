...
@SpringBootTest
class TradeByItemIdManagerBuyAndSellEditStage8FinishCallbackTest {
    @MockBean
    private BotInnerService botInnerService;

    @Test
    public void initAndExecute_should_save_user_trade_manager_by_user_inputs_and_notify_user() {
        TradeByItemIdManagerBuyAndSellEditStage8FinishCallback commandExecutor = new TradeByItemIdManagerBuyAndSellEditStage8FinishCallback();
