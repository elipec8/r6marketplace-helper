...
@SpringBootTest
class TradeByItemIdManagerSellEditStage6FinishCallbackTest {
    @MockBean
    private BotInnerService botInnerService;

    @Test
    public void initAndExecute_should_save_user_trade_manager_and_notify_user() {
        TradeByItemIdManagerSellEditStage6FinishCallback commandExecutor = new TradeByItemIdManagerSellEditStage6FinishCallback();
