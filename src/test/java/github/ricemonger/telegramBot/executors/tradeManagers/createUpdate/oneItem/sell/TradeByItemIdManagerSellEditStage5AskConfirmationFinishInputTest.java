...
@SpringBootTest
class TradeByItemIdManagerSellEditStage5AskConfirmationFinishInputTest {
    @MockBean
    private BotInnerService botInnerService;

    @Test
    public void initAndExecute_should_process_last_input_and_ask_confirmation() {
        TradeByItemIdManagerSellEditStage5AskConfirmationFinishInput commandExecutor = new TradeByItemIdManagerSellEditStage5AskConfirmationFinishInput();
