...
class CredentialsAddPasswordInputTest {
    ...
    public void initAndExecute_should_throw_exception_to_next_method_if_thrown() {
        ...
        assertThrows(RuntimeException.class, () -> ubiAccountEntryAuthorizeStage3Ask2FaCodeInput.initAndExecute(MockUpdateInfos.UPDATE_INFO_PASSWORD_INPUT, botInnerService));
    }
}