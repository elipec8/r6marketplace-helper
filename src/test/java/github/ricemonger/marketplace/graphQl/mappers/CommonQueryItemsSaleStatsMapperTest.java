...
class CommonQueryItemsSaleStatsMapperTest {
    ...
    public void mapItemsSaleStats_should_call_map_itemSaleStats_for_each_node() throws ParseException {
        ...
        node2.setPriceHistory(List.of(new PriceHistory(dtf.format(LocalDateTime.MIN), 100, 200, 500, 6)));
        ...
        GroupedItemDaySalesUbiStats expected2 = new GroupedItemDaySalesUbiStats("2",
                List.of(new ItemDaySalesUbiStats("itemId", LocalDate.MIN, 100, 200, 500, 6)));
    ...
    public void mapItemSaleStats_should_set_itemId_and_call_mapAllItemDaySales() throws ParseException {
        ...
        node.setPriceHistory(List.of(new PriceHistory(dtf.format(LocalDateTime.MIN), 100, 200, 500, 6)));

        GroupedItemDaySalesUbiStats expected = new GroupedItemDaySalesUbiStats("1", List.of(new ItemDaySalesUbiStats("1", LocalDate.MIN, 100, 200,
                500, 6)));
    ...
    public void mapAllItemDaySales_should_call_mapItemDaySales_for_each_priceHistory() throws ParseException {
        ...
        PriceHistory priceHistory1 = new PriceHistory(dtf.format(LocalDateTime.MIN), 100, 200, 500, 6);
        PriceHistory priceHistory2 = new PriceHistory(dtf.format(LocalDateTime.MIN.plusDays(1)), 200, 300, 600, 7);
        List<PriceHistory> priceHistories = List.of(priceHistory1, priceHistory2);

        ItemDaySalesUbiStats expected1 = new ItemDaySalesUbiStats("itemId", LocalDate.MIN, 100, 200, 500, 6);
        ItemDaySalesUbiStats expected2 = new ItemDaySalesUbiStats("itemId", LocalDate.MIN.plusDays(1), 200, 300, 600, 7);
