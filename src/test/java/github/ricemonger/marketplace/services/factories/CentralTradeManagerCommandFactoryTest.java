...
class CentralTradeManagerCommandFactoryTest {
    ...
    public void createCommandsForCentralTradeManagersForUser_should_return_expected_list_of_commands() {
        ...
        CentralTradeManagerCommand commandCreateSell = new CentralTradeManagerCommand(userId, authorizationDTO, chatId, privateNotificationsEnabledFlag,
        ...
        CentralTradeManagerCommand commandUpdateSell = new CentralTradeManagerCommand(userId, authorizationDTO, chatId, privateNotificationsEnabledFlag,
        ...
        CentralTradeManagerCommand commandCancelSell = new CentralTradeManagerCommand(userId, authorizationDTO, chatId,
                privateNotificationsEnabledFlag, CentralTradeManagerCommandType.SELL_ORDER_CANCEL, currentSellTradeBeCanceled.getItemId(),
        ...
        CentralTradeManagerCommand commandCreateBuy = new CentralTradeManagerCommand(userId, authorizationDTO, chatId, privateNotificationsEnabledFlag,
        ...
        CentralTradeManagerCommand commandUpdateBuy = new CentralTradeManagerCommand(userId, authorizationDTO, chatId, privateNotificationsEnabledFlag,
        ...
        CentralTradeManagerCommand commandCancelBuy = new CentralTradeManagerCommand(userId, authorizationDTO, chatId, privateNotificationsEnabledFlag,
        ...
        List<CentralTradeManagerCommand> result = centralTradeManagerCommandFactory.createCommandsForCentralTradeManagerForUser(resultingSellTrades, currentSellTrades, resultingBuyTrades, currentBuyTrades, userId, authorizationDTO, chatId, privateNotificationsEnabledFlag);
