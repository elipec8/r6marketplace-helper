...
class ItemServiceTest {
    ...
    public void recalculateAndSaveAllItemsHistoryFields_should_recalculate_only_history_fields_and_save_all_items() {
        ...
        List<ItemDaySalesUbiStats> existingItemDaySalesUbiStats = List.of(item1Day7Stats, item1Day30Stats, item1Day32Stats, item2Day15Stats);
        when(itemSaleUbiStatsService.findAllForLastMonth()).thenReturn(existingItemDaySalesUbiStats);
