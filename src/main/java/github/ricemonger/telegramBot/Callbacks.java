...
public class Callbacks {
    ...
    public static final String SILENT_CANCEL = "SILENT_CANCEL";
    ...
    public static final String FILTER_TYPE_DENY = "FILTER_TYPE_DENY";

    public static final String FILTER_ITEM_IS_OWNED = "FILTER_ITEM_IS_OWNED";

    public static final String FILTER_ITEM_IS_NOT_OWNED = "FILTER_ITEM_IS_NOT_OWNED";

    public static final String FILTER_ITEM_IS_OWNED_ANY = "FILTER_ITEM_IS_OWNED_ANY";
