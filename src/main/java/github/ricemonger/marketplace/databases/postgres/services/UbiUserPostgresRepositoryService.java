...
import github.ricemonger.marketplace.services.UbiUserRepositoryService;
...
public class UbiUserPostgresRepositoryService implements UbiUserRepositoryService {
    ...
    public Collection<String> getOwnedItemsIds(String chatId, String email) {
        ...
        return user != null ? user.getOwnedItemsIds() : null;
    }
