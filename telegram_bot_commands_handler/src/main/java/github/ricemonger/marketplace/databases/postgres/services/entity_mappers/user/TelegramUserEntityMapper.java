...
public class TelegramUserEntityMapper {
    ...
    public InputStateAndGroupTelegramUserEntity createInputStateAndGroupEntity(String chatId, InputState inputState, InputGroup inputGroup) {
        return new InputStateAndGroupTelegramUserEntity(chatId, inputState, inputGroup);
    }
}
