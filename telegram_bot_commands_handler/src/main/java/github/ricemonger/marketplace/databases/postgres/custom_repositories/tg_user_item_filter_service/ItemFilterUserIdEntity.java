...
@Entity(name = "Item_filter_user_id_entity")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@IdClass(ItemFilterUserIdEntityId.class)
public class ItemFilterUserIdEntity {
    @MapsId
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemFilterUserIdEntity itemFilterEntity)) {
            return false;
        }
